...
但是：
* 其假设W和H的非负性不符合生物学的实际。
* 其假设gene program之间正交不符合基因多效性吧

还有一种NMF，限制\\(\mathbf{W}\\)或\\(\mathbf{H}\\)其中一个矩阵非负，另一个矩阵则可以包含负数。我们限制\\(\mathbf{W}\\)矩阵非负，解除\\(\mathbf{H}\\)矩阵的正交假设，可以弥补oNMF方法中的上述缺陷。
...
```
![semiNMF_gene_program_heatmap.png](https://oldcountlost.github.io/images/semiNMF_gene_program_heatmap.png)
...
```
![semiNMF_program_cell_heatmap.png](https://oldcountlost.github.io/images/semiNMF_program_cell_heatmap.png)
![semiNMF_gene_program_clusteredheatmap.png](https://oldcountlost.github.io/images/semiNMF_gene_program_clusteredheatmap.png)
...
plt.show()
```
![例子boxPlot(program14)](https://oldcountlost.github.io/images/semiNMF_KO_program_boxplot.png)
...
plt.show()
```
![semiNMF_program_GO_dotplot.png](https://oldcountlost.github.io/images/semiNMF_program_GO_dotplot.png)
