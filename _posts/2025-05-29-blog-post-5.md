...
![gene clustered](../../../../images/elastic_net_gene_cluster.png)

 \\(k)\\ 个敲除的组，每个组作为一个pseudo-bulk，其表达量的umap为：
![KO group](../../../../images/elastic_net_KO_cluster.png)

 \\(k)\\ 个敲除的组（x轴），基因的24个聚类簇（y轴），其平均表达量的热图为：
![gene program ~ KO group](../../../../images/elastic_net_KO-program.de.png)
...
![gene program ~ KO group p-value](../../../../images/elastic_net_KO-program.png)
