...
线性模型为 \\[\mathbf{\hatE}\_{n \times g} = \mathbf{D}\_{n \times k} \cdot \mathbf{W}\_{k \times g} + \mathbf{C}\_{n \times c} \cdot \mathbf{M}\_{c \times g} \\] 
\\[\mathbf{E}\_{n \times g} - \mathbf{\hatE}\_{n \times g} = \mathbf{U}\_{n \times g}\\] 
