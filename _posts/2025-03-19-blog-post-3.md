...
{}           &   { = \int { \left( { q(c,t,m|x,s) \log{ p(x|c,t,s)} +  q(c,t,m|x,s) \log{ \frac{ p(c,t|s)}{q(c,t,m|x,s)} } } \right) } dcdtdm }  \\
{}            &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s)} - \int q(c,t,m|x,s) log \frac{q(c|x,s) \ q(t|x,s) \ q(m|s,t)}{ p(c,t|s)} dcdtdm } \\
{}           &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s) } - {D}_{KL}(q(c|x,s)||p(c)) - {D}_{KL}(q(t|x,s)||p(t)) +  \mathbb{E}_{q(c,t,m|x,s)} log \frac{p(t|s)}{ q(m|s,t)}  } \\
              \\
