...
{}             &   { \geq  \int q(c,t,m|x,s)  \log{p(x|c,t,s)} dcdtdm -  \int q(c,t|x,s) \log{ \frac{  q(c,t|x,s) }{ p(c,t|s) } } dcdt +  \int  q(t|x,s) \log{ q(m|t)} dt} & { (ELBO) }\\
...
{}           &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s) } - {D}_{KL}(q(c,t|x,s)||p(c,t))   +  \mathbb{E}_{q(t|x,s)} \log{ q(m|t) } } \\
              \\
