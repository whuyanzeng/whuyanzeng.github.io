...
{}              &  { = p(x|c, t, s) \ p(c|s) \ p(t|s) } \\
                    \\
{ q(c,t,m|x,s) }   &  { = q(c,t|x,s) \ q(m|s,t) } \\
{}                &  { = q(t|x,s) \ q(c|x,s) \ q(m|s,t) } \\
                 \\
{ log p(x|s) }   &  { = log \int p(x,c,t|s)dcdt  } \\
{}             &   { = log \int q(c,t,m|x,s)  \frac{p(x|c,t,s) \ p(c,t|s)}{q(c,t,m|x,s) } dcdtdm  } \\
{}             &   { \geq \int q(c,t,m|x,s) \log{ \frac{p(x|c,t,s) \ p(c,t|s)}{q(c,t,m|x,s)}} dcdtdm  } \\
{}           &   { = \int { \left( { q(c,t,m|x,s) \log{ p(x|c,t,s)} +  q(c,t,m|x,s) \log{ \frac{ p(c|s) \ p(t|s) }{q(c,t,m|x,s)} } } \right) } dcdtdm }  \\
{}            &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s)} - \int q(c,t,m|x,s) log \frac{q(c|x,s) \ q(t|x,s) \ q(m|s,t)}{ p(c|s) \ p(t|s) } dcdtdm } \\
{}           &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s) } - {D}_{KL}(q(c|x,s)||p(c|s)) - {D}_{KL}(q(t|x,s)||p(t|s)) - \int q(t|x,s) \ q(c|x,s) \ q(m|s,t) \log{ q(m|s,t)}   dcdtdm   } \\
              \\
