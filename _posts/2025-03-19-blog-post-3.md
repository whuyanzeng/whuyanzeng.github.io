...
{}            &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s)} - \int q(c,t,m|x,s) log \frac{q(c|x,s) \ q(t|x,s) \ q(m|s,t)}{ p(c,t|s)} dcdtdm } \\
{}           &   { = \mathbb{E}_{q(c,t,m|x,s)} \log{ p(x|c,t,s) } - {D}_{KL}(q(c|x,s)||p(c|s)) - {D}_{KL}(q(t|x,s)||p(t|s)) +  \mathbb{E}_{q(c,t,m|x,s)} log \frac{p(t|s)}{ q(m|s,t)}  } \\
              \\
