...
{}             &   { = \log{ \int q(c,t|x,s)  \frac{p(x|c,t,s) \ p(c,t|s) }{q(c,t|x,s)} dcdt } + \log{ \int   \ q(m|t) \ q(t|x,s) dt }  } \\
  {}             &   { = \log{ \int q(c,t|x,s)  \frac{p(x|c,t,s) \ p(c,t|s) }{ q(c,t|x,s) } dcdt } + \log{ \int   \ q(m|t) \ q(t|x,s) dt }  } \\
  {}             &   { \geq   \underbrace{  \int q(c,t|x,s)  \log{ \frac{ p(x|c,t,s) \ p(c,t|s)}{  q(c,t|x,s) }  } dcdt +  \int  q(t|x,s) \log{ q(m|t)} dt  }_\textbf{ ELBO (根据Jensen 不等式) }  } \\
{}            &   { = \int q(c,t|x,s) \log{  p(x|c,t,s) dcdt}  +  \int  q(c,t|x,s)  \log{ \frac{ p(c,t|s) }{ q(c,t|x,s) } dcdt}  +  \int  q(t|x,s) \log{  q(m|t)   dt }   } \\
  {}            &   { = \mathbb{E}_{q(c,t|x,s)} \log{ p(x|c,t,s)} - \int q(c,t|x,s) \log{ \frac{  q(c,t|x,s) }{ p(c,t|s) } } dcdt   +  \mathbb{E}_{q(t|x,s)} \log{ q(m|t) }  } \\
 {}            &   { = \underbrace{\mathbb{E}_{q(c,t|x,s)} \log{ p(x|c,t,s)} }_{ {- Loss_{reconst}}  } + \underbrace{\left( { - {D}_{KL}(q(c,t|x,s)||p(c,t)) } \right)}_{ - Loss_{KLD} }  + \underbrace{ \mathbb{E}_{q(t|x,s)} \log{ q(m|t) }   }_{- Loss_{Classify} }  } \\
              \\
\end{array}</p>
